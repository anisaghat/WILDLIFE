...
public class MammalDAOCSV implements IDAO<Mammal> {

    private final File file;
    private final List<Mammal> mammals = new ArrayList<>();
    private final HabitatDAOCSV habitatDAO;

    public MammalDAOCSV(String filePath, HabitatDAOCSV habitatDAO) {
    ...
    @Override
    public int create(Mammal mammal) {
        if (mammal == null) return -1;
        if (findById(mammal.getId()) != null) return -1;
    ...
    @Override
    public Mammal findById(Integer id) {
